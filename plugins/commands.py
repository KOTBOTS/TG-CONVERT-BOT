...
support = "https://telegram.dog/KOT_REPORS"
...
async def start(c, m):
    ...
    await c.send_message(chat_id=m.chat.id,
                         ...
                         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("My Father 👨‍💻", url=my_father), InlineKeyboardButton("📌support group", url=support)]]))
